...
const DEFAULT_TEMPLATES = {
  device_confirmation: {
    ...
    script_text: `Hi! This is Adam with [Company Name]! Am I speaking with [Patient Name]?
...
This is Adam with [Company Name]. We're just reaching out in regards to the [Device] for your [Body Part] that Dr. [Doctor's Name] prescribed.
We just want to confirm if the one we delivered to you is still working properly or if you need a replacement? Please feel free to reply to this message or give us a call back at 000-000-0000. Thank you!`,
  },
...
Hi [Patient First Name], this is in regards to the [Device] that Dr. [Doctor's Name] had prescribed for your [Body Part]. It's already covered by your [Insurance Type] Insurance and we're giving you a call to let you know that the device will be delivered to you in the Surgery Center on [SX Date].

Our product specialist, [PS Name], will be the one to bring it to you. But if you do have any questions any time, feel free to call us at 000-000-0000, okay?

Alright! Well, it was great talking to you! Thank you so much for your time, [Patient First Name]. Have a great day!

TEXT/VM:
Hi [Patient First Name],
This is Adam with [Company Name] and this is in regards to the [Device] that Dr. [Doctor's Name] had prescribed for your [Body Part]. It's already covered by your [Insurance Type] Insurance and we're reaching out to let you know that the device will be delivered to you in the Surgery Center on [SX Date].
Our product specialist, [PS Name], will be the one to bring it to you. If you do have any questions any time, feel free to call us at 000-000-0000. Thank you!`,
  },
...
Hi [Patient First Name], my name is Adam and I'm calling with [Company Name] regarding the [Device] for your [Body Part] that Dr. [Doctor's Name] prescribed. How are you?
...
Alright! We're all set! Once you receive the [Device], you can just go back to this message. But if you do have any questions about setup or anything else, you can reply to my text or give us a call at 000-000-0000. Okay?

Alright! Well, it was great talking to you! Thank you so much for your time, [Patient First Name]. Have a great day! Take care!

TEXT/VM:
Hi [Patient First Name],
This is Adam with [Company Name] and this is in regards to the [Device] that Dr. [Doctor's Name] had prescribed for your [Body Part]. It's already covered by your [Insurance Type] Insurance and we're reaching out to coordinate the delivery.
Let me know when it would be best to call you back or feel free to give us a call back at 000-000-0000. Thank you!`,
  },
};
